...
describe("<DisplayCooperResult />", () => {
    ...
    describe("evaluates the correct result for female/poor", () => {
        beforeAll(() => {
            describedComponent = shallow(
                <DisplayCooperResult distance="1000" gender="feamle" age="23" />
    ...
    describe("evaluates the correct result for female/average", () => {
        beforeAll(() => {
            describedComponent = shallow(
                <DisplayCooperResult distance="200" gender="female" age="23" />
            );
        });

        it("and returns the assessment", () => {
            expect(describedComponent.find("p#cooper-message").text()).toEqual("Result: Average");
